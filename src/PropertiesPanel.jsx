...
// const items=useSelector((state)=>state.sections.items)
  ...
  const handleChange = (key, value) => {
    ...
    console.log("droppedItems in PP==>",updatedDroppedItems)
    setDroppedItems(updatedDroppedItems);

  };
  // useEffect(() => {}), [itemId];
console.log(item, "item in properties panel","droppedItems",droppedItems);
  return (
    <>
      <div
        onClick={onClose}
          ...
          <div className="flex gap-4 mb-4">
            <div className="flex-1">
              ...
              <input
                ...
                onChange={(e) => handleChange("minLength", parseInt(e.target.value, 10))}
              />
            </div>
            <div className="flex-1">
